...
const Dashboard: React.FC<DashboardProps> = ({ onAlertsUpdate, onNavigate }) => {
  ...
  return (
    <div className="dashboard-container ocean-ripples">
      {/* Statistics Cards */}
      ...
      <div className="main-content-grid">
        ...
        >
          <div className="card gradient-border hover-tilt" style={{ padding: '1rem', height: '600px' }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-bold text-white glow-text">Live Maritime Map</h2>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button className="btn btn-primary hover-tilt">
              Export Data
            </button>
          </div>
        </div>
